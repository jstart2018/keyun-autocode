package com.jstart.keyunautocodebackend.utils;
...
public class WebScreenshotUtils {
    ...
    private static WebDriver initChromeDriver(int width, int height) {
        try {
            ...
            throw new BusinessException(ResultEnum.SYSTEM_ERROR, "初始化 Chrome 浏览器失败");
        }
    }
    ...
    private static void saveImage(byte[] imageBytes, String imagePath) {
        try {
            ...
            throw new BusinessException(ResultEnum.SYSTEM_ERROR, "保存图片失败");
        }
    }
    ...
    private static void compressImage(String originalImagePath, String compressedImagePath) {
        ...
        try {
            ...
            throw new BusinessException(ResultEnum.SYSTEM_ERROR, "压缩图片失败");
        }
    }

    /**
     * 等待页面加载完成
     * 使用 JavaScript 检查 document.readyState 是否为 complete
     * 并额外等待一段时间，确保动态内容加载完成
     */
