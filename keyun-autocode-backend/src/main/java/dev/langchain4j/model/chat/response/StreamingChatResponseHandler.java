...
public interface StreamingChatResponseHandler {
    ...
    /**
     *
     *  this callback is called as soon as partial tool is available
     *  can be called multiple times
     *  can be called for multiple tool executions,
     *  give example of how this and other callback can be called
     * @param index TODO
